# Generated by Powerlevel10k configuration wizard on 2020-07-25 at 00:02 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=34 # 31
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=34 # 103
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=40 # 39
  ...
  # respectively.
  typeset -g POWERLEVEL9K_DIR_TRUNCATE_BEFORE_MARKER=first ##false
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{magenta}%B'   # bold magenta            old: %76F green foreground
